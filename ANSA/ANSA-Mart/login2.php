<?php 
        ...
        if (isset($_POST['logg'])) {
            ...
            if (!empty(trim($user_name)) || !empty(trim($password)) || !empty($account_type)) {
                
                $pwd=sha1($password);
                $query="SELECT *FROM buyer WHERE user_name='{$user_name}' and password='{$pwd}'";
                $re=mysqli_query($con,$query);
                if ($re) {
                    
                    $_SESSION['user_name']=$user_name;
                    header("Location:addCart.php?pro_id=".$id);
                }
            }
        }
 ?>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_form">
                        <div class="login_part_form_iner">
                            ...
                            <form class="row contact_form" action="login2.php" method="post" >
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <font color="green">In bellow mention your Account type</font><br><br>
                                    <input type="radio" class="" id="" name="account_type" value="Buyer"
                                        > Buyer <br><br>
                                    <input type="radio" class="" id="" name="account_type" value="Admin"
                                        > Admin
    
                                </div>
                                <div class="col-md-12 form-group">
                                    
                                    <button type="submit" value="submit" class="btn_3" name="logg">
                                        log in
                                    </button>
