...
<body>
    ...
    <section class="banner_part">
        ...
        <div class="banner_img">
            <img src="img/wrough.jpg" alt="#" class="img-fluid">
                ...
                <div class="col-lg-12">
                        ...
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="img/SAH0031-960x775.jpg" class="img-fluid" alt="#">
                                    <img src="img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="single_product_content">
                                    <h5>Started from $05</h5>
                                    <h2> <a href="single-product.php">Wrought Iron Rack</a> </h2>
                    ...
                    <div class="single_product_iner">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="img/chair.jpg" class="img-fluid" alt="#">
                                    <img src="img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="single_product_content">
                                    ...
                                    <h2> <a href="single-product.php">Wrought Iron chairs</a> </h2>
                                    <a href="product_list.php" class="btn_3">Explore Now</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="single_product_iner">
                        <div class="row align-items-center justify-content-between">
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_img">
                                    <img src="img/canddle.jpg" class="img-fluid" alt="#">
                                    <img src="img/product_overlay.png" alt="#" class="product_overlay img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="single_product_content">
                                    <h5>Started from $02</h5>
                                    <h2> <a href="single-product.php">Wrought Iron Candles</a> </h2>
                                    <a href="product_list.php" class="btn_3">Explore Now</a>
                                </div>
                            </div>
                        </div>
